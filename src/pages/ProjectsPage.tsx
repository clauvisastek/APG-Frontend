  ...
  const handleWizardSubmit = (validationRequest: ProjectValidationRequest) => {
    ...
    const newProject: Project = {
      ...
      client: {
        ...
        country: (projectData.clientCountry as Country) || Country.CANADA,
        defaultCurrency: projectData.currency as Currency,
        defaultTargetMargin: projectData.margins.targetMarginPercent,
        defaultMinMargin: projectData.margins.minMarginPercent,
